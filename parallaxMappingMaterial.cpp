...
// ==========================================================
// ParallaxMappingMaterial の実装
// ==========================================================

// スロット2用の定数バッファを生成する
bool ParallaxMappingMaterial::CreateMaterialBuffer(ID3D11Device* pDevice)
{
...
// 描画時に呼ばれるバインド処理
void ParallaxMappingMaterial::Bind(ID3D11DeviceContext* pContext)
{
    if (!pContext) return;
    ...
    if (m_pNormalHeightMapTextureRV) {
        pContext->PSSetShaderResources(1, 1, &m_pNormalHeightMapTextureRV);
    }
}
