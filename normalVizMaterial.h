...
class NormalVizMaterial : public Material
{
public:
...
public:
    NormalVizMaterial() : m_pMaterialBuffer(nullptr) {
        m_cbData.vMaterialColor = DirectX::XMFLOAT4(1, 1, 1, 1);
    }
    ~NormalVizMaterial() override { if (m_pMaterialBuffer) m_pMaterialBuffer->Release(); }
